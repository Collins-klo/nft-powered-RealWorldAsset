...
const EstateDetails = ({ investment, remainingDays }) => {
  ...
  return (
    <div className="w-5/6 m-auto bg-gradient-to-b from-[#000000] to-[#533e71] p-6 rounded-[15px]">
      {isLoading && <Load />}
      ...
      <div className="w-full flex md:flex-row flex-col mt-5 gap-[30px]">
        <div className="flex-1 flex-col">
          <div className="flex flex-row gap-2">
            <img src={investment.image} alt="investment" className="w-2/3 h-[438px] object-cover rounded-xl" />
            <div className="w-1/3 flex flex-col h-[430px] gap-2">
              <img src={investment.image2} alt="investment2" className="w-full h-[215px] object-cover rounded-xl" />
              <img src={investment.image3} alt="investment3" className="w-full h-[215px] object-cover rounded-xl" />
            </div>
          </div>
          <div className="mt-2">
            <div className="flex items-center gap-2">
              <div className="relative w-full h-[5px] bg-[#533e71]">
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5 ">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              <div className="w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#d8d2f3] cursor-pointer">
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-[#ffffff] uppercase">Monthly Rent Estimate</h4>
            <div className="mt-[20px]">
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#000000] border-[1px] border-[#9d7ed6] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              <input 
                ...
                step="2.5"
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#9d7ed6b6] bg-transparent font-epilogue text-[#322543] text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px]"
                value={amount}
                onChange={(e) => setAmount(e.target.value)}
              />

              <div className="my-[20px] p-4 bg-[#322543] rounded-[10px]">
              ...
              <CustomButton 
                btnType="button"
                title="Mint"
                styles="w-full bg-[#533e71] border-[1px] border-[#65468d]"
