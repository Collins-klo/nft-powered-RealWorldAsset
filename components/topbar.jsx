...
const Topbar = () => {
    ...
    const [isActive, setIsActive] = useState('estates');
  ...
  return (
    ...
    mb-[23px] gap-6">  
        ...
        bg-[#1c1c24] rounded-[100px] m-auto">
            <input type="text" placeholder="Search for investment" className="flex
            w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b5264] 
            text-white bg-transparent outline-none" />

            <div className="w-[60px] h-full rounded-[20px] bg-[#65468d]
